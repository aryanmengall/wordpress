...
// WP-Optimize advanced-cache.php (written by version: 3.8.0) (homeurl: http://localhost/wordpress/) (abspath: D:\xampp\htdocs\wordpress/) (do not change this line, it is used for correctness checks)
...
$possible_plugin_locations = array(
	...
	'D:\xampp\htdocs\wordpress\wp-content\plugins\wp-optimize\cache',
);
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'D:\xampp\htdocs\wordpress\wp-content\plugins\wp-optimize\cache/extensions');
}
